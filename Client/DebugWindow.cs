...
//                     InitGUI();
//                 }
//                 windowRect = GUILayout.Window(6705 + Client.WINDOW_OFFSET, windowRect, DrawContent, "DarkMultiPlayer - Debug", windowStyle, layoutOptions);
//             }
//             CheckWindowLock();
//         }
// 
...
//                     connectionText = "Last send time: " + GameClient.Instance.GetStatistics("LastSendTime") + "ms.\n";
//                     connectionText += "Last receive time: " + GameClient.Instance.GetStatistics("LastReceiveTime") + "ms.\n";
//                     connectionText += "Queued outgoing messages (High): " + GameClient.Instance.GetStatistics("HighPriorityQueueLength") + ".\n";
//                     connectionText += "Queued outgoing messages (Split): " + GameClient.Instance.GetStatistics("SplitPriorityQueueLength") + ".\n";
//                     connectionText += "Queued outgoing messages (Low): " + GameClient.Instance.GetStatistics("LowPriorityQueueLength") + ".\n";
//                     connectionText += "Queued out bytes: " + GameClient.Instance.GetStatistics("QueuedOutBytes") + ".\n";
//                     connectionText += "Sent bytes: " + GameClient.Instance.GetStatistics("SentBytes") + ".\n";
//                     connectionText += "Received bytes: " + GameClient.Instance.GetStatistics("ReceivedBytes") + ".\n";
