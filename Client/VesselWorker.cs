...
//         private static VesselWorker m_instance;
//         //Update frequency
...
//                         GameClient.Instance.SendVesselProtoMessage(sendProto, true, isFlyingUpdate);
...
//                                     GameClient.Instance.SendKerbalProtoMessage(pcm);
//                                 }
//                                 else
//                                 {
...
//                         GameClient.Instance.SendVesselProtoMessage(checkProto, false, isFlyingUpdate);
//                     }
//                     else
//                     {
...
//                 if (update != null)
//                 {
//                     GameClient.Instance.SendVesselUpdate(update);
//                 }
//             }
//         }
...
//                     GameClient.Instance.SendKerbalProtoMessage(protoKerbal);
//                     generateKerbals--;
//                 }
//             }
...
// 
//                 if (kerbalsDodged && (GameClient.Instance.state == ClientState.STARTING) && !LockSystem.Instance.LockExists("control-" + currentProto.vesselID) && !LockSystem.Instance.LockExists("update-" + currentProto.vesselID))
//                 {
//                     DarkLog.Debug("Sending kerbal-dodged vessel " + currentProto.vesselID + ", name: " + currentProto.vesselName);
//                     GameClient.Instance.SendVesselProtoMessage(currentProto, false, false);
...
//                 }
//                 GameClient.Instance.SendVesselRemove(dyingVesselID, true);
...
//                 serverVesselsPositionUpdate.Remove(dyingVesselID);
//             }
//             GameClient.Instance.SendVesselRemove(dyingVesselID, false);
//         }
// 
...
//             GameClient.Instance.SendVesselRemove(recoveredVesselID, false);
//         }
// 
...
//             GameClient.Instance.SendVesselRemove(terminatedVesselID, false);
//         }
// 
...
//             if (m_instance != null)
//             {
//                 m_instance.workerEnabled = false;
//                 Client.UpdateEvent -= m_instance.Update;
//                 if (m_instance.registered)
//                 {
//                     m_instance.UnregisterGameHooks();
//                     if (m_instance.wasSpectating)
//                     {
//                         InputLockManager.RemoveControlLock(DARK_SPECTATE_LOCK);
//                     }
//                 }
//             }
//             m_instance = new VesselWorker();
//             Client.updateEvent.Add(m_instance.Update);
//             
//         }
// 
